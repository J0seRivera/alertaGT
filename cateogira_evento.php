...
$consulta = "SELECT * FROM gt_categoria_evento";
       ...
       <li class="nav-item ">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item active" href="cateogira_evento.php">CATEGORIA_EVENTO</a>
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="formUsuarios">    
            ...
            <input type="text" class="form-control" id="username" placeholder="idcategoria" required>
            <div class="invalid-feedback" style="width: 100%;">
              Es necesario llenar este campo.
                ...
                <div class="row"> 
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">Nombre Categoria</label>
                    <input type="text" class="form-control" id="ncategoria">
                    </div>               
                    </div>  
                </div>
