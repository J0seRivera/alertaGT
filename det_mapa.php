...
$consulta = "SELECT * FROM gt_detalle_mapa";
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Detalle</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="iddetalle" required>
            <div class="invalid-feedback" style="width: 100%;">
             ...
             <div class="row">
                    <div class="col-lg-6">
                        ...
                        <select class="custom-select d-block w-100" id="mapa" required>
              ...
              <option>No.1 xxxx</option>
               ...
               <div class="row">
                    <div class="col-lg-6">
                        ...
                        <select class="custom-select d-block w-100" id="departamento" required>
              <option value="">Seleccionar</option>
              <option>No.1 xxxx</option>
            </select>
                        </div>
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Coordenadas</label>
