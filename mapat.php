          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  <th scope="col">ID Mapa</th>
                  <th scope="col">ID Tipo</th>
                  <th scope="col">ID Informe</th>
                  <th scope="col">ID Cuenta Usuario</th>
                  <th scope="col">Fecha Mapa</th>
                  <th>Acciones</th>
                </tr>
                </thead>
                <tbody>
                <?php                            
                            ...
                            <tr>
                                ...
                                <td><?php echo $dat['id_cuenta_usuario'] ?></td>
                                <td><?php echo $dat['fecha_mapa'] ?></td>
                                <td>
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Mapa</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="idmapa" required>
            <div class="invalid-feedback" style="width: 100%;">
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">ID Tipo</label>
                         <select class="custom-select d-block" id="tipo" required>
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">ID Informe</label>
                         <select class="custom-select d-block" id="informe" required>
              <option value="">Seleccionar</option>
              <option></option> 
            </select>
                        </div>
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">ID Cuenta usuariio</label>
                         <select class="custom-select d-block" id="cusuario" required>
              <option value="">Seleccionar</option>
              <option></option> 
            </select>
                        </div>
