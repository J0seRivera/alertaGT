...
$consulta = "SELECT * FROM gt_vitacora_alerta";
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
       ...
       <li class="nav-item ">
        ...
        <li class="nav-item ">
             <a class="nav-link active" href="vitacora.php">Vitacora</a>
           </li>
              ...
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <?php                            
                            ...
                            <tr>
                                ...
                                <td><?php echo $dat['tabla_afectada'] ?></td>
                                <td><?php echo $dat['cambios_capturados'] ?></td>
                                <td><?php echo $dat['tipo_transaccion'] ?></td>
                                <td><?php echo $dat['fecha_transaccion'] ?></td>
                                <td>
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Grado</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="idgrado" required>
            <div class="invalid-feedback" style="width: 100%;">
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Nombre Grado</label>
                    <input type="text" class="form-control" id="ngrado">
                        </div>
                    </div>    
                  </div>
