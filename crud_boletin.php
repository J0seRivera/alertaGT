...
$consulta = "SELECT * FROM gt_boletin";
...
<div class="nav-scroller bg-white shadow-sm">
  <nav class="nav nav-underline">
    ...
    <a class="nav-link" href="buzon_boletin.html">Buzón de Boletines</a>
  </nav>
</div>
...
<main role="main" class="container">
  <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
    ...
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Boletines de Eventos</h6>
    </div>
  </div>
              ...
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <th scope="col">Fecha</th>
                   <th scope="col">Nombre del Boletin</th>
                ...
                <?php                            
                            ...
                            <tr>
                                ...
                                <td><?php echo $dat['fecha_boletin'] ?></td>
                                <td><?php echo $dat['nombre_boletin'] ?></td>
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="formUsuarios">    
            ...
            <input type="text" class="form-control" id="username" placeholder="boletin" required>
            ...
            <div class="invalid-feedback" style="width: 100%;">
              Your id is required.
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Nombre del Boletín</label>
                        <input type="text" class="form-control" id="nboletin">
                        </div>
                    </div>    
                    <div class="col-lg-6">    
                        <div class="form-group">
                        <label for="" class="col-form-label">No. Informe</label>
                        <select class="custom-select d-block w-100" id="ninforme" required>
