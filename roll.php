...
$consulta = "SELECT * FROM gt_roll_cuenta";
            ...
            <div class="table-responsive">
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <?php                            
                            ...
                            ?>
                            <tr>
                                <td><?php echo $dat['id_roll'] ?></td>
                              
                                <td><?php echo $dat['nombre_roll'] ?></td>
                                <td>
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Roll</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="idroll" required>
            <div class="invalid-feedback" style="width: 100%;">
              Es necesario llenar este campo.
                ...
                <div class="row"> 
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">Nombre Roll</label>
                    <input type="text" class="form-control" id="nroll">
                    </div>               
                    </div>  
                </div>
