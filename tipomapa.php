...
$consulta = "SELECT * FROM gt_tipo_mapa";
              ...
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <?php                            
                            ...
                            <tr>
                                ...
                                <td><?php echo $dat['nombre_mapa'] ?></td>
                                <td>
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="formUsuarios">    
            ...
            <input type="text" class="form-control" id="username" placeholder="idtipom" required>
            <div class="invalid-feedback" style="width: 100%;">
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Nombre Mapa</label>
                    <input type="text" class="form-control" id="nmapa">
                        </div>
                    </div>    
                  </div>
