...
$consulta = "SELECT * FROM gt_sensor";
              ...
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <?php                            
                            ...
                            <tr>
                                ...
                                <td><?php echo $dat['nombre_sensor'] ?></td>
                                <td>
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Sensor</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="idsensor" required>
            <div class="invalid-feedback" style="width: 100%;">
              Es necesario llenar este campo.
                ...
                <div class="row"> 
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">Nombre Sensor</label>
                    <input type="text" class="form-control" id="nsensor">
                    </div>               
                    </div>  
                </div>
