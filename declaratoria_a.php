...
$consulta = "SELECT * FROM gt_declaracion_alerta-";
       ...
       <li class="nav-item ">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item active" href="declaratoria_a.php">GT_DECLARATORIA_ALERTA</a>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  <th scope="col">ID Declaración</th>
                  <th scope="col">Nombre Declaración</th>
                ...
                <?php                            
                            ...
                            ?>
                            <tr>
                                <td><?php echo $dat['id_declaracion'] ?></td>
                                <td><?php echo $dat['nombre_declaracion'] ?></td>
                                <td>
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Declaración</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="iddeclaracion" required>
            <div class="invalid-feedback" style="width: 100%;">
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Nombre Declaración</label>
                    <input type="text" class="form-control" id="ndeclaracion">
                        </div>
                    </div>    
                  </div>
