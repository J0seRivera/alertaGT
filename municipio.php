...
$consulta = "SELECT * FROM gt_municipio";
              ...
              <table id="userList" class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                  <?php                            
                            ...
                            ?>
                            <tr>
                                <td><?php echo $dat['id_municipio'] ?></td>
                                <td><?php echo $dat['nombre_municipio'] ?></td>
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">ID Municipio</label>
                       <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text">ID</span>
            </div>
            <input type="text" class="form-control" id="username" placeholder="idmunicipio" required>
            <div class="invalid-feedback" style="width: 100%;">
              ...
              <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Nombre Municipio</label>
                    <input type="text" class="form-control" id="nmunicipio">
                        </div>
                    </div>    
                  </div>
               <div class="row">
                    <div class="col-lg-6">
                        ...
                        <select class="custom-select d-block w-100" id="idepto" required>
